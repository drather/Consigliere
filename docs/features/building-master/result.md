...
- 실패: 41410(군포시) 1건 — 502 서버오류, 재시도 후 53건 수집 완료
- 0건: 28710, 28720(인천 강화·옹진), 41590(화성), 41800·41820·41830(가평·연천·여주) — 아파트 단지 없는 지역

### 매핑 결과
| 항목 | 수치 |
|---|---|
| apt_master 전체 | 6,037건 |
| 매핑 성공 (≥ 0.8) | **2,701건 (44.7%)** |
| — score = 1.0 (완벽) | 2,026건 |
| — score 0.9~1.0 | 102건 |
| — score 0.8~0.9 | 573건 |
| 임계값 미달 | 3,336건 |
...
| 시도 | 매핑 | 전체 | 비율 |
|---|---|---|---|
| 서울특별시 | 695건 | 1,582건 | 44% |
| 인천광역시 | 398건 | 853건 | 47% |
| 경기도 | 1,494건 | 3,280건 | 46% |
