...
> **⚠️ 절대 규칙:**
> - `ranked_candidates`에 있는 단지만 출력하십시오. 단지를 추가하거나 분리하거나 합치지 마십시오.
> - 각 기준의 점수는 반드시 `ranked_candidates[n].scores` 필드의 값을 그대로 사용하십시오. 추정하거나 기억에서 인용하지 마십시오.
> - 총점도 `ranked_candidates[n].total_score` 값을 그대로 사용하십시오.
